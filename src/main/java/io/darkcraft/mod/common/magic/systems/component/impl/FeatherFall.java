...
public class FeatherFall implements IComponent, IMagnitudeComponent, IDurationComponent
{
	...
	@Override
	public String getUnlocalisedName(){return "darkcraft.component.featherfall";}

	@Override
	public ResourceLocation getIcon(){return MagicalRegistry.componentTex;}

	private final UVStore uv = new UVStore(0.4,0.5,0.0,0.1);
	@Override
