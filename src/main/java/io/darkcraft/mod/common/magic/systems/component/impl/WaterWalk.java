...
public class WaterWalk implements IComponent, IDurationComponent
{
	...
	@Override
	public String getUnlocalisedName(){return "darkcraft.component.waterwalk";}

	@Override
	public ResourceLocation getIcon(){return MagicalRegistry.componentTex;}

	private final UVStore uv = new UVStore(0.3,0.4,0.0,0.1);
	@Override
