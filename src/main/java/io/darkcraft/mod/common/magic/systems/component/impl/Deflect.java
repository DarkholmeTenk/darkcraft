...
import io.darkcraft.mod.common.magic.systems.effects.EffectDeflect;
...
public class Deflect implements IComponent, IDurationComponent
{
	...
	public void apply(ICaster caster, Entity entity, int magnitude, int duration, int config)
	{
		...
		if(ees != null)
			ees.addEffect(new EffectDeflect(caster,ent,magnitude,duration*20));
	}
	...
	@Override
	public String getUnlocalisedName(){return "darkcraft.component.deflect";}

	@Override
	public ResourceLocation getIcon(){return MagicalRegistry.componentTex;}

	private final UVStore uv = new UVStore(0.5,0.6,0.0,0.1);
	@Override
